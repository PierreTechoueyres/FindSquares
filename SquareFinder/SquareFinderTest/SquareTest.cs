...
public class SquareTest
{
    ...
    [Fact]
    public void CanThrowExecptionWhenBuildingAnInvalidSquare()
    {
        Action constructor = () => new Square(new Point(-1, -1), new Point(2, 1), new Point(4, 2), new Point(4, 2));
        constructor.Should().Throw<Exception>()
            .Which.Message.StartsWith("This isn't a square !!!");
